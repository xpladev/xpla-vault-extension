...
import { isDenomNative } from '@xpla.kitchen/utils';
...
const SwapForm = () => {
  ...
  const createTx = useCallback(
    (values: TxValues) => {
      const { mode, offerAsset, askAsset, input, slippageInput, ratio } =
        values;
  ...
  const slippageDisabled = [offerAsset, askAsset].every(isDenomNative);
        ...
        <Form onSubmit={handleSubmit(submit.fn)}>
          ...
          {!slippageDisabled && (
            <SlippageControl
              ...
              input={Number(slippageInput)} // to warn
              inputMode="decimal"
