...
// 1. NFT asset list
// 2. Transfer tx form
const NFTAssetItemERC721 = ({ contract, id, compact, tx }: Props) => {
  const { t } = useTranslation();

  const { data, ...state } = useTokenInfoERC721(contract, id);
          ...
          <>
            ...
            >
              <Grid gap={12}>
                ...
                {extension && <NFTDetails data={extension} id={id} evm nft />}
              </Grid>
            </ModalButton>

            <InternalLink
              to={{
                pathname: '/evm/nft/transfer/',
...
export default NFTAssetItemERC721;
