...
import { useXplaValidators } from 'data/Xpla/XplaAPI';
...
const Validators = () => {
  ...
  const activeValidators = useMemo(() => {
    if (!(validators && XplaValidators)) return null;
    ...
    return validators
      ...
      .map((validator) => {
        ...
        const indexOfXplaValidator = XplaValidators.findIndex(
          (validator) => validator.operator_address === operator_address,
        );

        const XplaValidator = XplaValidators[indexOfXplaValidator];

        const rank = indexOfXplaValidator + 1;
      ...
      <>
        ...
        <Table
          ...
          columns={[
            ...
            {
              title: t('Rewards'),
              tooltip: t('Estimated monthly rewards with 100 XPLA staked'),
